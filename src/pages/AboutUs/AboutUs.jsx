  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#816F68] via-[#9F838C] to-[#C9C9EE] text-white flex flex-col items-center px-6 py-12">
      ...
      <p className="max-w-3xl text-lg text-center mb-8 text-[#F5F5F5]">
        Born from a love for convenience and community, <span className="font-semibold text-[#BAABBD]">Panda Shops</span> started with a simple dream:
      ...
      <div className="mt-12 bg-[#BAABBD] text-black p-6 rounded-2xl max-w-4xl text-center shadow-lg">
        ...
        <p className="mb-4">
          Whether you're here to shop, explore, or just passing by—we're grateful to have you. Panda Shops is built for you, by people like you.
        </p>
