...
const Settings = () => {
  ...
  return (
    <div className="min-h-screen p-10 w-[80%] text-[#816F68] font-sans">
      <h2 className="text-3xl font-bold mb-6 text-[#8D7471] text-center">Account Settings</h2>
      
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8">
        <div className="space-y-6">
          {/* Username */}
          <div>
            <label className="block text-sm text-[#9F838C] mb-2">Username</label>
            <input 
              type="text" 
              value={username} 
          ...
          {/* Password */}
          <div>
            <label className="block text-sm text-[#9F838C] mb-2">Password</label>
            <input 
              type="password" 
              value={password} 
