    ...
    <footer className="bg-[#816F68] text-white py-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="text-center md:text-left">
          <h3 className="text-xl font-semibold text-[#C9C9EE] mb-4">Quick Links</h3>
          <div className="flex flex-col gap-3">
            <NavLink to="/home" className="hover:text-[#9AD1D4] transition-colors">Home</NavLink>
            <NavLink to="/about" className="hover:text-[#9AD1D4] transition-colors">About Us</NavLink>
            <NavLink to="/contact" className="hover:text-[#9AD1D4] transition-colors">Contact</NavLink>
            <NavLink to="/shop" className="hover:text-[#9AD1D4] transition-colors">Shop</NavLink>
          </div>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex flex-col gap-2 text-white/80">
            <p className="flex items-center gap-2"><FaPhoneAlt className="text-[#9AD1D4]" /> +977-9803389703</p>
            <p className="flex items-center gap-2"><FaPhoneAlt className="text-[#9AD1D4]" /> +977-9818284446</p>
            <p className="flex items-center gap-2"><FaPhoneAlt className="text-[#9AD1D4]" /> +977-9851026442</p>
          </div>
        </div>
      </div>
